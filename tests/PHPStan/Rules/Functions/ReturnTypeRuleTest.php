...
class ReturnTypeRuleTest extends \PHPStan\Testing\RuleTestCase
{
	...
	{
		return new ReturnTypeRule(new FunctionReturnTypeCheck(new RuleLevelHelper($this->createBroker(), true, false, true)), self::getContainer()->getByType(ReflectionProvider::class));
	}

	public function testReturnTypeRule(): void
	{
		$this->getReflectionProvider()->requireFile(__DIR__ . '/data/returnTypes.php');
